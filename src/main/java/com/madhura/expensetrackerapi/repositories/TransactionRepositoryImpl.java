...
public class TransactionRepositoryImpl implements TransactionRepository{
    ...
    @Override
    public Integer create(Integer userId, Integer categoryId, Double amount, String note, Integer transactionDate) throws EtBadRequestException {
        try {
    ...
    @Override
    public void update(Integer userId, Integer categoryId, Integer transactionId, Transaction transaction) throws EtResourceNotFoundException {
        try{
