package com.madhura.expensetrackerapi.resources;

import com.madhura.expensetrackerapi.domain.Transaction;
import com.madhura.expensetrackerapi.services.TransactionService;
...
public class TransactionResource {
    ...
    public ResponseEntity<Transaction> addTransaction(HttpServletRequest request, @PathVariable("categoryId") Integer categoryId,
        ...
        Integer transactionDate = (Integer) transactionMap.get("transactionDate");
